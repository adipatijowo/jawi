...
// Variables
const rootDomain = "adipatijowo.biz.id"; // Ganti dengan domain utama kalian
const serviceName = "cs"; // Ganti dengan nama workers kalian
const apiKey = "sHCEmsjjbmtWNZZWkLn5o-tx1uzS8rPcClevjXWj"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "adipatijowo@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "fe31050b0fc0fc296c6b90bcecfc0439"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "dc14bdca37c16325ad6579123413ad36"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
